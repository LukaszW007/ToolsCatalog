...
app.get('/tools', (req, res) => {
    const params = null;
    dbConnection('SELECT * FROM tools', params, res);
...
app.post('/tools/add', (req, res) => {//TODO
    ...
    const sql = `INSERT INTO tools(set_name,description) VALUES (?,?);`;
    dbConnection(sql, [setName, description], res);
    console.log(`Added new tool `,setName);
});
...
app.delete('/tools/delete/:id', (req, res) => {
    ...
    console.log(`Deleted tool with ID `,deleteTooolID);
});
...
app.post('/users/add', (req, res) => {
    ...
    dbConnection(sql, [userId, userName], res);
...
app.get('/borrow/check', (req, res) => {
    const usersSetName = req.params.name; //TODO change from SELECT to UPDATE
